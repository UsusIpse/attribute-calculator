...
include_once('UsusWoocommercePriceCalculator_OptionsManager.php');

class UsusWoocommercePriceCalculator_InstallIndicator extends UsusWoocommercePriceCalculator_OptionsManager {
