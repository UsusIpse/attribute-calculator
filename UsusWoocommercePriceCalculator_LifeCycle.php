...
include_once('UsusWoocommercePriceCalculator_InstallIndicator.php');

class UsusWoocommercePriceCalculator_LifeCycle extends UsusWoocommercePriceCalculator_InstallIndicator {
